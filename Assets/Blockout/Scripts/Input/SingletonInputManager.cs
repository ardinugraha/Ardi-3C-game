...
public class SingletonInputManager : SingletonBehaviour<SingletonInputManager>
{
    ...
    private void CheckMainMenuInput()
    {
        ...
        {
            // Debug.Log("Main Menu Input Pressed");
            // if (OnMainMenuInput != null)
            // {
            //     OnMainMenuInput();
            // }
            SingletonGameManager.Instance.BackToMainMenu();
        }
    }
